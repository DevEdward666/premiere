    ...
    <View style={styles.container}>
      ...
      <ScrollView
        ...
        <Text style={styles.tcP}>
          Welcome to Premiere App. If you continue to browse and use this
          ...
          govern TUO IT Solutions’s relationship with you in relation to this
          website. If you disagree with any part of these terms and conditions,
          please do not use our website.
        </Text>
        <Text style={styles.tcP}>
          The term ‘TUO IT Solutions’ or ‘us’ or ‘we’ refers to the owner of the
